...
public class Question {
    ...
    public Question(String questionText, String option1, String option2, String option3, String option4, int correctAnsNo, int valueQA) {
    ...
    public int getValueQA() {
        return valueQA;
    }

    public void setValueQA(int valueQA) {
        this.valueQA = valueQA;
    }
}
